...
export ADDONS_REPOS="
core,${CORE_ADDONS_REPO:-https://github.com/lferran/microk8s-core-addons},${CORE_ADDONS_REPO_BRANCH:-MK-502-upgrade-nginx-ingress-controller-to-1-2-0-to-address-cve}
